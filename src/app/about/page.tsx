      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">Self-Employed | Remote • Aug 2025 - Present</p>
      ...
      >
        ...
        >
          <motion.div 
            ...
            {...cardHoverSmall}
          >
            <h3 className="text-xl font-semibold mb-2">SRM Institute of Science and Technology — Chennai, India</h3>
            <p className="text-primary mb-2">Bachelor of Technology in Computer Science and Engineering • Jun 2022 – May 2026</p>
            <p className="text-secondary">
            CGPA: 7.38/10 (Current)
            </p>
            <p className="text-secondary">
            Coursework: Data Structures and Algorithms, Object-Oriented Programming, Artificial Intelligence, Database Management Systems, Operating Systems, Machine Learning, Cloud Computing, Computer Networks
            </p>
          </motion.div>
        </motion.div>
      </motion.section>
